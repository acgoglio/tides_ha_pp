...
expname=['MFSe1r1_2017','SIMU-EAS1r1','EAS1r1','EAS1r1_3']
colexp=['r','k','b','g']
nexp=len(expname)
...
'S.nc_600_btm_ts','S.nc_basin_ts','sossheig_ts','sohefldo_ts','sowaflup_ts','soshfldo_ts','velmodw_ts',\
...
'vosaline','vosaline','vosaline','vosaline','sossheig','sohefldo','sowaflup','soshfldo','velmodw',\
...
'Sea Surface Height','Net Downward Heat Flux','Net Upward Water Flux','Downward Shortwave Radiation','Wind Stress',\
...
'[$^\circ$C]','[$^\circ$C]','[$^\circ$C]','[$^\circ$C]','[PSU]','[PSU]','[PSU]','[PSU]','[PSU]','[cm]','[W/m$^2$]','[Kg/m$^2$/s]','[W/m$^2$]','[m/s]',\
#'[m]','[W/m$^2$]',\

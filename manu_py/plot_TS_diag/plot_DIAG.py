...
pathdir1='/work/md04916/exp/eas4/appo_eas3/diag/diag_base.xml/'
pathdir2='/work/md04916/exp/eas4/appo_eas4/diag/diag_base.xml/'

figdir='/work/ec04916/FIGURE/DIAG/'+expname[0]+'_'+expname[1]+'/'

T_avg=np.matrix([[2017,1,1],[2018,12,31]])

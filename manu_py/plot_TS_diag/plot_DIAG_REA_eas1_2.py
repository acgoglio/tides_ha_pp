...
expname=['MFSe1r1','MFSe1r1','SIMU-EAS1r1','EAS1r1','EAS1r1_2','EAS1r1_2','EAS1r1_2modif']
colexp=['r','r','k','b','g','g','c']
nexp=len(expname)

pathdir=['/work/md04916/exp/MFS_EAS1/cf_exp/exp_mrsp.sh/diag_base_eas1_pp.xml/',\
'/work/md04916/exp/MFS_EAS1/cf_expm/exp_mrsp.sh/diag_base_eas1_cfm.xml/',\
'/work/md04916/exp/MFS_EAS1/myp_sim/exp_mrsp.sh/diag_base_eas1.xml/',\
'/work/md04916/exp/MFS_EAS1/myp_ass/exp_mrsp.sh/diag_base_eas1.xml/',\
...
'/work/md04916/exp/MFS_EAS1/ec_mod/exp_mrsp.sh/diag_base_eas1.xml/201801/']  

#cf_exp = REA16 Claudia da catalogo
#cf_expm = REA16 Claudia da model output
#myp_sim = REA16 Max simulazione
#myp_ass = REA16 Max reanalisi_1 2016-2017
...
T_avg=np.matrix([[2016,1,1],[2016,12,31]])
...
#Evaluates the time period
        ...
        if exp == 0:   
          data_ini=datetime.date(1970, 1, 1) + datetime.timedelta(days=time1[0]/(24*60*60))
          data_fin=datetime.date(1970, 1, 1) + datetime.timedelta(days=time1[-1]/(24*60*60)+1)
          print(data_ini)
          print(data_fin)
        if exp == 1 or exp == 2 or exp == 3 or exp == 4 or exp == 5 or exp == 6:
...
#        ax.plot(times1,VAR1,colexp[exp],label=expname[exp],linewidth=1.5)
        if exp==0 or exp==2 or exp==3 or exp==4:
          ax.plot(times1,VAR1,colexp[exp],label=expname[exp],linewidth=1.5)

...
expname=['EAS3','EAS4','EAS4a','simu_EAS4a']
colexp=['r','b','k','g']
nexp=len(expname)

pathdir=['/work/md04916/exp/eas4/appo_eas3/diag/diag_base.xml/',\
'/work/md04916/exp/eas4/appo_eas4/diag/diag_base.xml/',\
'/work/ec04916/exp/eas5/EAS4_a_PJ/exp_mrsp.sh/diag_base.xml/',\
'/work/ec04916/exp/eas5/simu_EAS4_a/exp_mrsp.sh/diag_base.xml/']


figdir='/work/ec04916/FIGURE/DIAG/'+expname[0]+'_'+expname[-1]+'/'

T_avg=np.matrix([[2015,1,1],[2016,12,31]])

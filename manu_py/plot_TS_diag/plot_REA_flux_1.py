...
expname=['EAS1r1_2','EAS1r1_2']
colexp=['g','g']
nexp=len(expname)


pathdir=['/work/md04916/exp/MFS_EAS1/myp3_ass/exp_mrsp.sh/diag_base_eas1.xml/',\
...
filename=['soevapor_ts','solafldo_ts','solofldo_ts','soprecip_ts','sosefldo_ts']
varname=['soevapor','solafldo','solofldo','soprecip','sosefldo']

varlongname = ['Water Evaporation Flux','Latent Downward Heat Flux over open ocean',\
    'Longwave Downward Heat Flux over open ocean','Precipitation Flux',\
    'Sensible Downward Heat Flux over open ocean']

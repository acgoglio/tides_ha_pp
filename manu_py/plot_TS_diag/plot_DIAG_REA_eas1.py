...
expname=['EAS3','SIMU-MFSe1r1','MFSe1r1']
colexp=['r','b','k']
nexp=len(expname)

pathdir=['/work/md04916/exp/eas4/appo_eas3/diag/diag_base.xml/',\
...
#Evaluates the time period
        ndays=len(time1)
        if exp == 0:   
          data_ini=datetime.date(1900, 1, 1) + datetime.timedelta(days=time1[0]/24)
          data_fin=datetime.date(1900, 1, 1) + datetime.timedelta(days=time1[-1]/24+1)
          print(data_ini)
          print(data_fin)
        if exp == 1:

...
#
# ACG 23/06/2019
# Script for extraction of daily and hourly TS  
# Ini file: p_extr.ini 
#
#set -u
set -e
...
############## HOURLY MODEL OUTPUT EXTRACTION #######################
if [[ $HOURLY_FLAG == 1 ]] ; then
...
############## DAILY MODEL OUTPUT EXTRACTION #######################
elif [[ $DAILY_FLAG == 1 ]]; then

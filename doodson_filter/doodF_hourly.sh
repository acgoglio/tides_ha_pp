#!/bin/bash
#
# Anna Chiara Goglio 19/01/2020
# Script for tidal detiding with Doodson filter 
# Ini file: filter.ini 
# WARNING: CDO required!
#
#
#set -u
set -e
#set -x 
################### ENV SETTINGS ##############################
# src directory (where this code and the ini file are located) 

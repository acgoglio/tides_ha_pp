...
# Initialize global matrix for Foreman distances
...
#    print (comp+' d_foreman: '+str(d_foreman))
  ...
  for nnn_AP in range (0,len(TOT_stations_lab_ord)):
      ...
      print ('--')
      print (TOT_stations_lab_ord[nnn_AP])
      print (TOT_A_obs_ord[nnn_AP],TOT_P_obs_ord[nnn_AP],TOT_A_mod_ord[nnn_AP],TOT_P_mod_ord[nnn_AP])
      print((TOT_A_obs_ord[nnn_AP]*np.cos(TOT_P_obs_ord[nnn_AP])-(TOT_A_mod_ord[nnn_AP]*np.cos(TOT_P_mod_ord[nnn_AP])))**2)
      print((TOT_A_obs_ord[nnn_AP]*np.sin(TOT_P_obs_ord[nnn_AP])-(TOT_A_mod_ord[nnn_AP]*np.sin(TOT_P_mod_ord[nnn_AP])))**2)
      d_foreman[nnn_AP+1][comp_idx+1]=np.sqrt((TOT_A_obs_ord[nnn_AP]*np.cos(TOT_P_obs_ord[nnn_AP])-(TOT_A_mod_ord[nnn_AP]*np.cos(TOT_P_mod_ord[nnn_AP])))**2+((TOT_A_obs_ord[nnn_AP]*np.sin(TOT_P_obs_ord[nnn_AP])-(TOT_A_mod_ord[nnn_AP]*np.sin(TOT_P_mod_ord[nnn_AP])))**2))
      print (d_foreman[nnn_AP+1][comp_idx+1])
...
# Compute Distances in the complex plane [Foreman et al. 93] and RMSmisfits [V.Agreti thesis Formula 2.7]
#d_foreman=np.sqrt((GLOB_A_obs[i][j]*np.cos(GLOB_P_obs[i][j])-(GLOB_A_mod[i][j]*np.cos(GLOB_P_mod[i][j])))**2-(GLOB_A_obs[i][j]*np.sin(GLOB_P_obs[i][j])-(GLOB_A_mod[i][j]*np.sin(GLOB_P_mod[i][j]))**2))
...
for idx_color in range (howmany_Oarea+howmany_Marea+howmany_Garea+howmany_Aarea,howmany_Oarea+howmany_Marea+howmany_Garea+howmany_Aarea+howmany_Tarea):
    TOT_color_stz.append('cyan')
for idx_color in range (howmany_Oarea+howmany_Marea+howmany_Garea+howmany_Aarea+howmany_Tarea,howmany_Oarea+howmany_Marea+howmany_Garea+howmany_Aarea+howmany_Tarea+howmany_Earea):
